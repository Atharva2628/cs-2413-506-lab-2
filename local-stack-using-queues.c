...
int myStackPop(MyStack* stack_object) {
    ...
    //if stack not empty, de q and return front
...
void main() {
    MyStack* stack_object = myStackCreate();

    //stack elements: 10, 20, 30
    myStackPush(stack_object, 10);
    myStackPush(stack_object, 20);
    myStackPush(stack_object, 30);

    myStackTop(stack_object);

    myStackPop(stack_object);

    myStackTop(stack_object);

    myStackEmpty(stack_object);
    ...
    //checking pop and top for empty stack (underflow)
    myStackPop(stack_object);
    myStackTop(stack_object);

    myStackFree(stack_object);
}